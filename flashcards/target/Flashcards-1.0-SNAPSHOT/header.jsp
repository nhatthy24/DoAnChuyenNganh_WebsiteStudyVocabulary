									...
									<ul class="navbar__library-tab">
										<li class="navbar__library-tab-item ">
											<button class="navbar__library-tab-btn"
												id="library__tab-term">Học phần</button>

										</li>
										<li class="navbar__library-tab-item active">
											<button class="navbar__library-tab-btn"
												id="library__tab-folder">Thư mục</button>
										</li>
										<li class="navbar__library-tab-item">
											<button class="navbar__library-tab-btn"
												id="library__tab-class">Lớp học</button>
										</li>
									</ul>
								</div>
								<div class="navbar__library-content">
									...
									<div id="library-term" class="library__tab-content"
										...
										<div class="navbar__library-not-null">
											<div class="navbar__library-term">
												<ul class="navbar__library-term-list">
													<li class="navbar__library-term-item"><a href="#"
							...
							<div class="navbar__create-menu" id="navbar__create-menu"
								...
								<ul class="navbar__create-menu-list">
									...
									<li class="navbar__create-menu-item"><a href="#"
										class="navbar__create-menu-link"> <i class="far fa-folder"></i>
					...
					<div class="navbar__user" id="navbar__user">
						...
						<div class="navbar__user-menu" id="navbar__user-menu"
							...
							<ul class="navbar__user-items">
								...
								<li class="navbar__user-item"><a href="#"
									class="navbar__user-link"> Giới thiệu bạn bè </a></li>
								<li class="navbar__user-item"><a href="#"
									class="navbar__user-link"> Giúp đỡ và phản hồi </a></li>
								<li class="navbar__user-item"><a href="#"
									class="navbar__user-link"> Ứng dụng di dộng </a></li>
								<li class="navbar__user-item"><a href="#"
									class="navbar__user-link"> Blog </a></li>
								<li class="navbar__user-item"><a href="#"
									class="navbar__user-link"> Quyền riêng tư </a></li>
								<li class="navbar__user-item"><a href="#"
