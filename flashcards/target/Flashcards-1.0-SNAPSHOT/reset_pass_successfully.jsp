        ...
        <div class="SiteSimpleLayout">
            ...
            <div class="UIContainer">
                <div class="UIDiv SiteSimpleLayout-centered">
                    <h2 class="UIHeading UIHeading--two">Cập nhật mật khẩu thành công</h2>
                    <div class="UIDiv">
                        <form action="/forgotten/password" method="get">
                            <p class="UIParagraph">Mật khẩu của bạn được cập nhật thành công, vui lòng kiểm tra email.</p>
