            ...
            <c:forEach items="${cards}" var="card">
                <div class="term__detail-item">
                    <div class="term__detail-item-word">
                        <input type="text" value="${card.term}"
                               class="term__detail-item-input term__detail-item-word-text" readonly>
                    </div>
                    ...
                    <div class="term__detail-item-control">
                        <button class="term__detail-item-control-btn term__detail-star-btn--active"
                                onclick="tickStar(this)">
